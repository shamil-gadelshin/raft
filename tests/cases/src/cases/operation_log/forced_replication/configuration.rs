...
use raft::{
    ElectionTimer, NodeConfiguration, NodeLimits, NodeState, NodeWorker, OperationLog,
    PeerRequestChannels, PeerRequestHandler,
};
use raft_modules::{
    ClusterConfiguration, FixedElectionTimer, InProcClientCommunicator, MemoryOperationLog,
    MemoryRsm, MockNodeStateSaver,
};
...
pub fn create_node_configuration_inproc<Pc, Et, Log>(
    node_id: u64,
    all_nodes: Vec<u64>,
    communicator: Pc,
    election_timer: Et,
